...
try {
  ...
  console.log('[Startup] Loading Firebase...');
  // Require firebaseService to trigger early SDK configuration check
  require('./services/firebaseService');

  console.log('[Startup] Loading middleware and routes...');
  ...
  console.error('[Startup] ❌ Critical Startup Failure:', err.message);
